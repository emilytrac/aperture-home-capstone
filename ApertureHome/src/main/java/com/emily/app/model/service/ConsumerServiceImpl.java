...
public class ConsumerServiceImpl implements ConsumerService {
    ...
    public Product updateQuantity(String productName, int quantity) {
        ...
        Product product = restTemplate.exchange("http://localhost:8084/products/quantities/" + productName + "/" + quantity, HttpMethod.PUT, entity, Product.class).getBody();
        return product;
    }
    ...
    public ProductList searchByKeyword(String keyword) {
        ...
        ProductList products = restTemplate.getForObject("http://localhost:8084/products/searches/" + keyword, ProductList.class);
        return products;
    }
    ...
    public ProductList generateProductReport() {
        ...
        ProductList products = restTemplate.getForObject("http://localhost:8084/products/reports", ProductList.class);
        return products;
    }
